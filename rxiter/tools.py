...
class SharableAsyncIterable:
    ...
    def __aiter__(self):
        ...
        shar_iter = SharableAsyncIterator(self)
...
class ReplayAsyncIterable:
    ...
    def __aiter__(self):
        ...
        shar_iter = ReplayAsyncIterator(self)
...
def async_share_dec(async_iterable_fn):
    def wrapper(*args, **vargs):
        return SharableAsyncIterable(async_iterable_fn(*args, **vargs))
    return functools.cache(wrapper)

def async_replay_dec(async_iterator_fn):
    def wrapper(*args, **vargs):
        return ReplayAsyncIterable(async_iterator_fn(*args, **vargs))
    return functools.cache(wrapper)